    ...
    return links.map((link, index) => ({
      ...
      Action: (
        <Link
          ...
          className="border-[#144ee3] border-2  py-2 px-3 rounded-md text-[#144ee3] hover:bg-[#144ee3]
  ...
  return (
    <DashboardLayout>
      <div className="flex justify-between items-center mb-10">
        ...
        <button
          className="border-[#144ee3] border-2  py-3 px-4 rounded-md text-[#144ee3] hover:bg-[#144ee3]
           hover:text-white transition-all duration-700 text-lg"
      ...
      <Table
        columns={["sn", "Full Link", "Shortened Link", "Clicks", "Action"]}
        data={tableData}
      />
